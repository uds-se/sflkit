...
class ResultEncoder(json.JSONEncoder):
    ...
    def default(self, o: Any) -> Any:
        if isinstance(o, Suggestion):
            return {
                'locations': [
                    self.default(line) for line in o.lines
                ],
...
if __name__ == '__main__':
    ...
    commands = arg_parser.add_subparsers(title='command',
    ...
    instrument_parser.add_argument('-e', '--events', dest='events', default=None,
    ...
    analyze_parser.add_argument('-a', '--analysis', dest='analysis', default=None,
                                help='The dump file of the counts of the relevant and irrelevant, '
                                     'true and false analysis objects')
    analyze_parser.add_argument('-o', '--out', dest='out', default='out.json',
