...
class EventTests(unittest.TestCase):
    ...
    def test_branches_relevant(self):
        config = Config.config(
            ...
            language="python",
            events="branch",
            predicates="line,branch,condition",
            working=test_dir,
        )
        instrument_config(config)
