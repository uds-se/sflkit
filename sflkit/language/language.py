...
from sflkit.language.python.finder import PythonFunctionFinder, PythonLoopFinder, PythonBranchFinder
...
class Language(enum.Enum):
    ...
    def setup(self):
        AnalysisObject.set_finder(self.function_finder, self.loop_finder, self.branch_finder)
    ...
    PYTHON = (PythonInstrumentation,
              ...
              }, PythonVarExtract(), PythonVarExtract(use=True), PythonConditionExtract(),
              PythonFunctionFinder, PythonLoopFinder, PythonBranchFinder, ['py'])  # Equals PYTHON3
    PYTHON3 = PYTHON
    PYTHON2 = (None,
               {
                   EventType.LINE: python_factory.LineEventFactory,
               ...
               PythonFunctionFinder, PythonLoopFinder, PythonBranchFinder, ['py'])
