...
class Injection:
    ...
    def __init__(self, pre: List = None, body: List = None, body_last: List = None, orelse: List = None,
                 finalbody: List = None, error: List = None, post: List = None, assign: str = None,
...
class CombinationVisitor(MetaVisitor):
    ...
    def __init__(self, language, id_generator: IDGenerator, tmp_generator: TmpGenerator,
        ...
        self.visitors = [visitor(language, id_generator, tmp_generator) for
                         visitor in visitors]
