...
from sflkit.analysis.predicate import Branch, ScalarPair, VariablePredicate, ReturnPredicate, NonePredicate
from sflkit.analysis.predicate import EmptyStringPredicate, EmptyBytesPredicate, IsAsciiPredicate
from sflkit.analysis.predicate import ContainsDigitPredicate, ContainsSpecialPredicate, Condition
